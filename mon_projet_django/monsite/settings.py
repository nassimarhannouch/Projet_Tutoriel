...
AUTH_USER_MODEL = 'appcours.Utilisateur'

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-*q!71oe!v0nye048*qrwd@s89y!b_1(c=*)emw26g95w!f3=pf'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'monapp' / 'templates'],  # ✅ ne garder que celle-ci
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Ajoutez ces configurations pour django-plotly-dash
...
STATICFILES_DIRS = [
    BASE_DIR / "monapp/static",  # Ajoutez ce chemin si ce n'est pas déjà fait
]
